...
/** @var \ICC_GG_Redis_Object_Cache_Enabler_Plugin $this */
...
<div id="widget-redis-stats">
	...
	<ul>
		<li>
			<a class="active" href="#" data-chart="time" title="<?php esc_attr_e( 'The total amount of time (in milliseconds) it took Redis to return cache data.', 'icc-gg-redis-object-cache-enabler' ); ?>">
		...
		<li style="margin-left: auto;">
			<a href="<?php echo esc_url( network_admin_url( $this->page ) ); ?>">
				<?php esc_html_e( 'Settings', 'icc-gg-redis-object-cache-enabler' ); ?>
			</a>
		</li>
	</ul>
